...
def check_discord_sessions():
    ...
    login_response = requests.post(
        'https://flexmeet.preview.emergentagent.com/api/auth/login',
    ...
    bot_response = requests.get(
        'https://flexmeet.preview.emergentagent.com/api/discord/test-activity',
        headers=headers,
        verify=False
    )
    ...
    analytics_response = requests.get(
        'https://flexmeet.preview.emergentagent.com/api/discord/analytics',
        headers=headers,
        verify=False
    )
