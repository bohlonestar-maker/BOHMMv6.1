...
class BOHDirectoryAPITester:
    def __init__(self, base_url="https://moto-store-admin.preview.emergentagent.com/api"):
        ...
        if success:
            ...
            if 'invite_link' in invite_response:
                ...
                if '?token=' in invite_link:
                    ...
                    expected_base = "https://moto-store-admin.preview.emergentagent.com/accept-invite?token="
    ...
    def run_all_tests(self):
        ...
        # PRIORITY TEST: Role-Based Permission System (NEW - HIGHEST PRIORITY)
        print("\n🔥 RUNNING HIGHEST PRIORITY TEST: ROLE-BASED PERMISSION SYSTEM")
