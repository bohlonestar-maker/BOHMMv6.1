...
class BOHDirectoryAPITester:
    def __init__(self, base_url="https://flex-org-portal.preview.emergentagent.com/api"):
        ...
        if success:
            ...
            if 'invite_link' in invite_response:
                ...
                if '?token=' in invite_link:
                    ...
                    expected_base = "https://flex-org-portal.preview.emergentagent.com/accept-invite?token="
