...
import { FileSpreadsheet, Download, Users, DollarSign, UserCheck } from "lucide-react";
        ...
        <div className="bg-slate-800 rounded-lg p-4 sm:p-6 mb-4 sm:mb-6 border border-slate-700">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <button
              ...
              className="flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 disabled:opacity-50 px-4 py-3 rounded-lg font-semibold text-sm transition-colors"
            >
            ...
            <button
              ...
              disabled={reportLoading}
              className="flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 disabled:opacity-50 px-4 py-3 rounded-lg font-semibold text-sm transition-colors"
            >
            ...
            <button
              ...
              disabled={reportLoading}
              className="flex items-center justify-center gap-2 bg-orange-600 hover:bg-orange-700 disabled:opacity-50 px-4 py-3 rounded-lg font-semibold text-sm transition-colors"
            >
          ...
          <p className="text-xs text-slate-500 mt-3">
            Reports include totals, percentages, and per-month breakdowns for the selected quarter.
          </p>
        </div>
