...
def generate_final_report():
    ...
    login_response = requests.post(
        'https://moto-store-admin.preview.emergentagent.com/api/auth/login',
    ...
    analytics_response = requests.get(
        'https://moto-store-admin.preview.emergentagent.com/api/discord/analytics',
        headers=headers,
        verify=False
    )
    ...
    bot_response = requests.get(
        'https://moto-store-admin.preview.emergentagent.com/api/discord/test-activity',
        headers=headers,
        verify=False
    )
