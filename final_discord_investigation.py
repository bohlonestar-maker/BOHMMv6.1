...
def generate_final_report():
    ...
    login_response = requests.post(
        'https://club-ecommerce.preview.emergentagent.com/api/auth/login',
    ...
    analytics_response = requests.get(
        'https://club-ecommerce.preview.emergentagent.com/api/discord/analytics',
        headers=headers,
        verify=False
    )
    ...
    bot_response = requests.get(
        'https://club-ecommerce.preview.emergentagent.com/api/discord/test-activity',
        headers=headers,
        verify=False
    )
